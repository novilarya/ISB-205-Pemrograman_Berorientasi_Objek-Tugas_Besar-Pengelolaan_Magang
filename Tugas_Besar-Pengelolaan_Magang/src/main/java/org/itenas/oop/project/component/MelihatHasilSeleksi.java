 ...
 * @author aryan
 */
public class MelihatHasilSeleksi extends javax.swing.JPanel {

    /**
     * Creates new form KelolaMagangForm
     */
    public MelihatHasilSeleksi() {
        initComponents();
        TableDataAdmin();
    ...
    try {
        Statement stmt = conn.createStatement();
        String query = "SELECT nama, username FROM hasil_seleksi WHERE nama LIKE '%" + namaAdmin + "%'"; 
        ResultSet rs = stmt.executeQuery(query);
