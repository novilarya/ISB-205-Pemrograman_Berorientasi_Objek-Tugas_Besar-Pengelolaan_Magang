...
public class MelihatDaftarPendaftar extends javax.swing.JPanel {
    ...
    try {
        ...
        String query = "SELECT * FROM daftar_pendaftar_magang";
    ...
    private void cariTableDataPendaftar(String namaPendaftar) {
        ...
        try {
            Statement stmt = conn.createStatement();
            String query = "SELECT * FROM daftar_pendaftar_magang WHERE nama LIKE '%" + namaPendaftar + "%'";
            ResultSet rs = stmt.executeQuery(query);
    ...
    private void initComponents() {
        ...
        tablePendaftar.setBackground(new java.awt.Color(46, 80, 119));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtSearchNamaPendaftar, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        String username = tablePendaftar.getValueAt(pilihBaris, 1).toString();
